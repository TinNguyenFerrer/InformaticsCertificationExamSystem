...
namespace InformaticsCertificationExamSystem.Migrations
{
    ...
    [Migration("20221015052702_CreateTablebTestSchedule_TheoryTest")]
    partial class CreateTablebTestSchedule_TheoryTest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.Examination", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.Examination_ExaminationRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.ExaminationRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.FileSubmitted", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.FinalResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.InconsistentMark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.StudentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.Teacher_InconsistentMark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.TestSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.TestSchedule_TheoryTest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.TheoryTest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.Examination_ExaminationRoom", b =>
                {
                    b.HasOne("InformaticsCertificationExamSystem.Models.Examination", "Examination")
                        .WithMany("Examination_ExaminationRooms")
                        .HasForeignKey("ExaminationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InformaticsCertificationExamSystem.Models.ExaminationRoom", "ExaminationRoom")
                        .WithMany("Examination_ExaminationRooms")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.FileSubmitted", b =>
                {
                    b.HasOne("InformaticsCertificationExamSystem.Models.Student", "Student")
                        .WithOne("FileSubmitted")
                        .HasForeignKey("InformaticsCertificationExamSystem.Models.FileSubmitted", "FileOfStudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.FinalResult", b =>
                {
                    b.HasOne("InformaticsCertificationExamSystem.Models.Student", "Student")
                        .WithOne("FinalResult")
                        .HasForeignKey("InformaticsCertificationExamSystem.Models.FinalResult", "ResultOfStudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.InconsistentMark", b =>
                {
                    b.HasOne("InformaticsCertificationExamSystem.Models.Student", "Student")
                        ...
                        .HasForeignKey("InformaticsCertificationExamSystem.Models.InconsistentMark", "MarkOfStudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.Permission", b =>
                {
                    b.HasOne("InformaticsCertificationExamSystem.Models.Teacher", "Teacher")
                        .WithOne("Permission")
                        .HasForeignKey("InformaticsCertificationExamSystem.Models.Permission", "PermissionOfTeacherID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.Student", b =>
                {
                    b.HasOne("InformaticsCertificationExamSystem.Models.StudentType", "StudentType")
                        .WithMany("Students")
                        .HasForeignKey("StudentTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InformaticsCertificationExamSystem.Models.TestSchedule", "TestSchedule")
                        .WithMany("Students")
                        .HasForeignKey("TestScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InformaticsCertificationExamSystem.Models.TheoryTest", "TheoryTest")
                        .WithMany("Students")
            ...
            modelBuilder.Entity("InformaticsCertificationExamSystem.Models.Teacher_InconsistentMark", b =>
                {
                    b.HasOne("InformaticsCertificationExamSystem.Models.InconsistentMark", "InconsistentMark")
